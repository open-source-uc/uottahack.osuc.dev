...
export function app () {
  this.className = 'flex flex-col justify-center items-left w-full h-fit text-gray-800 gap-0 relative'
  ...
  return html`
    ...
    <section class="h-[900px] w-screen bg-cover bg-[url('https://2024.uottahack.ca/images/CompleteBackground.png')]">
      <article class="h-screen w-full flex flex-col justify-center items-left gap-6 text-white">  
